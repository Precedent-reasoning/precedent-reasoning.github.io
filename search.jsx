...
const APP_URL_HERO = window.APP_URL || "Legal Case Finder App.html";
const GITHUB_URL_HERO = "https://github.com/wei-research/AI-Legal-Search";
      ...
      <div className="container hero-grid">
        <div>
          ...
          <div className="hero-actions">
            ...
            <a className="btn btn-ghost btn-lg" href={GITHUB_URL_HERO} target="_blank" rel="noopener noreferrer">
          ...
          <div className="hero-powered">
            ...
            <div className="powered-items">
              ...
              <span className="powered-item"><span className="powered-dot"></span>Advanced AI Models</span>
